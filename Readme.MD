...
curl -LO https://github.com/maniSbindra/az-mpf/releases/download/v0.8.1/az-mpf_0.8.1_windows_amd64.tar.gz
tar -xzf az-mpf_0.8.1_windows_amd64.tar.gz
mv az-mpf_0.8.1_windows_amd64 az-mpf.exe
chmod +x ./az-mpf.exe
```
...
```shell
# Please change version in the URL to the latest version
curl -LO https://github.com/maniSbindra/az-mpf/releases/download/v0.8.1/az-mpf_0.8.1_darwin_arm64.tar.gz
tar -xzf az-mpf_0.8.1_darwin_arm64.tar.gz
...
Verifying artifact az-mpf_0.8.1_darwin_arm64.tar.gz: PASSED
