...
curl -LO https://github.com/maniSbindra/az-mpf/releases/download/v0.10.0/az-mpf_0.10.0_windows_amd64.tar.gz
tar -xzf az-mpf_0.10.0_windows_amd64.tar.gz
mv az-mpf_0.10.0_windows_amd64 az-mpf.exe
chmod +x ./az-mpf.exe
```
...
```shell
# Please change version in the URL to the latest version
curl -LO https://github.com/maniSbindra/az-mpf/releases/download/v0.10.0/az-mpf_0.10.0_darwin_arm64.tar.gz
tar -xzf az-mpf_0.10.0_darwin_arm64.tar.gz
...
curl -LO https://github.com/maniSbindra/az-mpf/releases/download/v0.10.0/az-mpf_0.10.0_darwin_arm64.tar.gz
curl -LO https://github.com/maniSbindra/az-mpf/releases/download/v0.10.0/multiple.intoto.jsonl

# modify path to the slsa-verifier binary as per your installation and verify the release binary
$ /PATH_TO_VERIFER/slsa-verifier verify-artifact az-mpf_0.10.0_darwin_arm64.tar.gz   --provenance-path multiple.intoto.jsonl   --source-uri github.com/maniSbindra/az-mpf  --source-tag v0.10.0
...
Verifying artifact az-mpf_0.10.0_darwin_arm64.tar.gz: PASSED
